        ...
        <div class="faq-body">
            ...
            <div class="col-md-7 faq-topics">
                ...
                <div id="faq_accordionp1" data-children=".item">
                    <!-- child item -->
                    <div class="item">
                        <a data-toggle="collapse" data-parent="#faq_accordionp1" href="#faq_accordion1" aria-expanded="true" aria-controls="faq_accordion1">
                ...
                <div id="faq_accordionp2" data-children=".item">
                    <!-- child item -->
                    <div class="item">
                        <a data-toggle="collapse" data-parent="#faq_accordionp2" href="#faq_accordion2" aria-expanded="true" aria-controls="faq_accordion2">
                ...
                <div id="faq_accordionp3" data-children=".item">
                    <!-- child item -->
                    <div class="item">
                        <a data-toggle="collapse" data-parent="#faq_accordionp3" href="#faq_accordion3" aria-expanded="true" aria-controls="faq_accordion3">
        ...
        <div class="faq-body">
            ...
            <div class="col-md-7 faq-topics">
                ...
                <div id="faq_accordionp4" data-children=".item">
                    <!-- child item -->
                    <div class="item">
                        <a data-toggle="collapse" data-parent="#faq_accordionp4" href="#faq_accordion4" aria-expanded="true" aria-controls="faq_accordion4">
                            What to pack
                        </a>
                ...
                <div id="faq_accordionp5" data-children=".item">
                    <!-- child item -->
                    <div class="item">
                        <a data-toggle="collapse" data-parent="#faq_accordionp5" href="#faq_accordion5" aria-expanded="true" aria-controls="faq_accordion5">
                            What about pets?
                        </a>
        ...
        <div class="faq-body">
            ...
            <div class="col-md-7 faq-topics">
                ...
                <div id="faq_accordionp6" data-children=".item">
                    <!-- child item -->
                    <div class="item">
                        <a data-toggle="collapse" data-parent="#faq_accordionp6" href="#faq_accordion6" aria-expanded="true" aria-controls="faq_accordion6">
                ...
                <div id="faq_accordionp7" data-children=".item">
                    <!-- child item -->
                    <div class="item">
                        <a data-toggle="collapse" data-parent="#faq_accordionp7" href="#faq_accordion7" aria-expanded="true" aria-controls="faq_accordion7">
                            Leaving the shelter / When you return home
                        </a>
